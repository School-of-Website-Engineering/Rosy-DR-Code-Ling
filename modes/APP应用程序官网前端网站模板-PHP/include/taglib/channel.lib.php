...
function lib_channel(&$ctag,&$refObj)
{
    ...
    if($type=='top')
    {
        $sql = "SELECT id,typename,seotitle,typedir,isdefault,description,content,ispart,defaultname,namerule2,moresite,siteurl,sitepath
    ...
    {
        $sql = "SELECT id,typename,seotitle,typedir,isdefault,ispart,description,content,defaultname,namerule2,moresite,siteurl,sitepath
            FROM `#@__arctype` WHERE reid='$reid' And ishidden<>1 order by sortrank asc limit 0, $line ";
        $dsql->SetQuery($sql);
      $dsql->Execute();
    }
